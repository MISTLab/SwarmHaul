#ifndef BUZZ_CONN_CONTROLLER_EPUCK_H
#define BUZZ_CONN_CONTROLLER_EPUCK_H
...
class CConnectivityBuzzControllerEPuck : public CBuzzController {
...
public:
   ...
   CConnectivityBuzzControllerEPuck();
   virtual ~CConnectivityBuzzControllerEPuck();
